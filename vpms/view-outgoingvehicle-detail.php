                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="manage-outgoingvehicle.php">Detalle del vehículo</a></li>
                                    <li class="active">Salida de vehículo</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Detalle de salida de vehículo</strong>
                        </div>
                        <div class="card-body">
