                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="bwdates-report-ds.php">Reporte por fechas</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Reporte de  entrada de vehículos</strong>
                        </div>
                        <div class="card-body">
                            <?php
...
?>
                ...
                <tr>
                  ...
                  <td><a href="view-incomingvehicle-detail.php?viewid=<?php echo $row['ID'];?>">Detalle</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
