                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Administrar perfil </strong>
                            </div>
...
?>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nombre administrador</label></div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="password-input" class=" form-control-label">Número de contacto</label></div>
