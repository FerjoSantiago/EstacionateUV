...
if(isset($_POST['submit']))
  {
    ...
    if ($query) {
    $msg="La categoria ha sido agregada";
  }
  else
    {
   ...
   <?php include_once('includes/header.php');?>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="add-category.php">Categoria</a></li>
    ...
    echo $msg;
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="catename" name="catename" class="form-control" placeholder="Ej: vehiculo de 4 llantas" required="true"></div>
                                    </div>
